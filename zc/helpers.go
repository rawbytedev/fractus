...
// The helpers below are copies of the zero-copy helper primitives.
// They are duplicated here intentionally as a first step: the next
// phase is to update callers to import `fractus/zc` and remove the
// duplicates from the main package.
